...
public class EssentialsEngine implements Listener
{
	// -------------------------------------------- //
	// INSTANCE & CONSTRUCT
	// -------------------------------------------- //

	private static EssentialsEngine i = new EssentialsEngine();
	public static EssentialsEngine get() { return i; }
	private EssentialsEngine() {}
	...
	public void handleTeleportOnHomeCommand(FactionsEventHomeTeleport event)
	{
